...
class CompileSpec extends FreeSpec with Matchers with CaseMatchers
    with BeforeAndAfterAll with ContextMixin {

  private implicit val runner = new Runner("test", Minijail)
  ...
  "Compile error" - {
    ...
    "for Java" - {
      "should tigger in trivial cases" in {
      ...
      "should trigger when class is not called Main" in {
    ...
    "for Karel" - {
      "should trigger for trivial cases" in {
        compileTest(CompileInputMessage("kj", List(("Main.kj", "foo")))) {
          _.status should equal ("compile error")
        }
      }

      "should not trigger with a correct program" in {
  ...
  "Status" - {
    "should be correctly assigned in C" in {
      runTest(
    ...
    "should be correctly assigned in Java" in {
      runTest(
    ...
    "should return TLE when exceeding overall time limit" in {
  ...
  "Exploits" - {
    "should be prevented" - {
      ...
      "Java6 parse double bug in compiler: CVE-2010-4476" in {
        compileTest(CompileInputMessage("java", List(("Main.java", """
          class Main {
            public static void main(String[] args) {
      ...
      "Java6 parse double bug in runtime: CVE-2010-4476" in {
        runTest(
          CompileInputMessage("java", List(("Main.java", """
            class Main {
              public static void main(String[] args) {
  ...
  "Custom validators" - {
    "should return JE when no validator present" in {
      compileTest(CompileInputMessage("c", List(("Main.c", """
        #include<stdio.h>
        #include<stdlib.h>
        int main() {
    ...
    "should return JE when validator is invalid" in {
      compileTest(CompileInputMessage("c", List(("Main.c", """
        #include<stdio.h>
        #include<stdlib.h>
        int main() {
    ...
    "should report 0 points when printing 0" in {
      runTest(
        CompileInputMessage("c", List(("Main.c", """
          #include<stdio.h>
          #include<stdlib.h>
    ...
    "should return JE when printing something non-numeric" in {
      runTest(
        CompileInputMessage("c", List(("Main.c", """
          #include<stdio.h>
          #include<stdlib.h>
    ...
    "should work correctly in Python" in {
      runTest(
        CompileInputMessage("cpp", List(("Main.cpp", """
          #include<iostream>
          int main() {
